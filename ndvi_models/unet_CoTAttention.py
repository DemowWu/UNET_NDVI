...
from ndvi_models.attention.CoTAttention import CoTAttention
...
class Unet6_512_CoTAttention1(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.att5 = CoTAttention(dim=256)
...
class Unet6_512_CoTAttention2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool4 = up_pooling(256, 128)
        self.att4 = CoTAttention(dim=128)
        self.up_conv4 = conv_bn_leru(256, 128)
...
class Unet6_512_CoTAttention3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention5(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention6(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention7(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention8(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention9(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_CoTAttention10(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool4 = up_pooling(256, 128)
        self.att4 = CoTAttention(dim=128)
        self.up_conv4 = conv_bn_leru(128 * 3, 128)
...
class Unet6_512_CoTAttention11(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool3 = up_pooling(128, 64)
        self.att3 = CoTAttention(dim=64)
        self.up_conv3 = conv_bn_leru(64 * 3, 64)
...
class Unet6_512_CoTAttention12(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool2 = up_pooling(64, 32)
        self.att2 = CoTAttention(dim=32)
        self.up_conv2 = conv_bn_leru(32 * 3, 32)
