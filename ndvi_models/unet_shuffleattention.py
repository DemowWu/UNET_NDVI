...
from ndvi_models.attention.ShuffleAttention import ShuffleAttention
...
class Unet6_512_ShuffleAttention1(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.att5 = ShuffleAttention(channel=256)
...
class Unet6_512_ShuffleAttention2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool4 = up_pooling(256, 128)
        self.att4 = ShuffleAttention(channel=128)
        self.up_conv4 = conv_bn_leru(256, 128)
...
class Unet6_512_ShuffleAttention3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool3 = up_pooling(128, 64)
        self.att3 = ShuffleAttention(channel=64)
        self.up_conv3 = conv_bn_leru(128, 64)
...
class Unet6_512_ShuffleAttention4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool2 = up_pooling(64, 32)
        self.att2 = ShuffleAttention(channel=32)
        self.up_conv2 = conv_bn_leru(64, 32)
...
class Unet6_512_ShuffleAttention5(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_ShuffleAttention6(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_ShuffleAttention7(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_ShuffleAttention8(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_ShuffleAttention9(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_ShuffleAttention10(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
    ...
    def forward(self, x):
        ...
        # uat5 = self.att5(up5)
        ux5 = self.att5(x5)
        ux5 = torch.cat([up5, x5 + ux5], dim=1)
        ux5 = self.up_conv5(ux5)

        up4 = self.up_pool4(ux5)
        # uat4 = self.att4(up4)  # add attetion 4
        ux4 = self.att4(x4)  # add attetion 4
        ux4 = torch.cat([up4, x4 + ux4], dim=1)
        ux4 = self.up_conv4(ux4)
...
class Unet6_512_ShuffleAttention11(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
    ...
    def forward(self, x):
        ...
        ux3 = self.att3(x3)  # add attetion 3
        ux3 = torch.cat([up3, x3 + ux3], dim=1)
        ux3 = self.up_conv3(ux3)
...
class Unet6_512_ShuffleAttention12(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
