...
from ndvi_models.attention.PSA import PSA
...
class Unet6_512_PSA1(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.att5 = PSA(channel=256, reduction=4, S=8)
...
class Unet6_512_PSA2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        # up
        self.up_pool5 = up_pooling(512, 256)
        self.att5 = PSA(channel=256, reduction=8, S=8)
        self.up_conv5 = conv_bn_leru(512, 256)

        self.up_pool4 = up_pooling(256, 128)
        self.att4 = PSA(channel=128, reduction=4, S=8)
        self.up_conv4 = conv_bn_leru(256, 128)
...
class Unet6_512_PSA3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool3 = up_pooling(128, 64)
        self.att3 = PSA(channel=64, reduction=4, S=8)
        self.up_conv3 = conv_bn_leru(128, 64)
...
class Unet6_512_PSA4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool2 = up_pooling(64, 32)
        self.att2 = PSA(channel=32, reduction=2, S=8)
        self.up_conv2 = conv_bn_leru(64, 32)
...
class Unet6_512_PSA5(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA6(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA7(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA8(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA9(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA10(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA11(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PSA12(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
