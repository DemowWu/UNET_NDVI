...
from ndvi_models.attention.BAM import BAMBlock
...
class Unet6_512_BAM1(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.att5 = BAMBlock(channel=256, reduction=16)
...
class Unet6_512_BAM2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool4 = up_pooling(256, 128)
        self.att4 = BAMBlock(channel=128, reduction=8)
        self.up_conv4 = conv_bn_leru(256, 128)
...
class Unet6_512_BAM3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool3 = up_pooling(128, 64)
        self.att3 = BAMBlock(channel=64, reduction=8)
        self.up_conv3 = conv_bn_leru(128, 64)
...
class Unet6_512_BAM4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool2 = up_pooling(64, 32)
        self.att2 = BAMBlock(channel=32, reduction=8)
        self.up_conv2 = conv_bn_leru(64, 32)
