...
from ndvi_models.attention.DANet import DAModule
...
class Unet6_512_DAUNet1(nn.Module):
...
class Unet6_512_DAUNet2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_DAUNet3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_DAUNet4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
    ...
    def forward(self, x):
        ...
        up2 = self.up_pool2(ux3)
        ux2 = self.att2(x2)  # add attetion 3
...
# 4->5
class Unet6_512_DAUNet5(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
# 5->6
class Unet6_512_DAUNet6(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
# 6->7
class Unet6_512_DAUNet7(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_DAUNet8(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
# 7->9
class Unet6_512_DAUNet9(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
# 8->10
class Unet6_512_DAUNet10(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
# 9->11
class Unet6_512_DAUNet11(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_DAUNet12(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
    ...
    def forward(self, x):
        ...
        up2 = self.up_pool2(ux3)
        uat2 = self.att2(up2)  # add attetion 3
        ux2 = self.att2(x2)  # add attetion 3
