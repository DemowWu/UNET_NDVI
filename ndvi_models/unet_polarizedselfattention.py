...
from ndvi_models.attention.PolarizedSelfAttention import ParallelPolarizedSelfAttention
...
class Unet6_512_PolarizedAttention1(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.att5 = ParallelPolarizedSelfAttention(channel=256)
...
class Unet6_512_PolarizedAttention2(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool4 = up_pooling(256, 128)
        self.att4 = ParallelPolarizedSelfAttention(channel=128)
        self.up_conv4 = conv_bn_leru(256, 128)
...
class Unet6_512_PolarizedAttention3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool3 = up_pooling(128, 64)
        self.att3 = ParallelPolarizedSelfAttention(channel=64)
        self.up_conv3 = conv_bn_leru(128, 64)
...
class Unet6_512_PolarizedAttention4(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool2 = up_pooling(64, 32)
        self.att2 = ParallelPolarizedSelfAttention(channel=32)
        self.up_conv2 = conv_bn_leru(64, 32)
...
class Unet6_512_PolarizedAttention5(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
    ...
    def forward(self, x):
        ...
        up5 = self.up_pool5(x6)
        up5 = self.att5(up5)  # add attetion 5
...
class Unet6_512_PolarizedAttention6(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PolarizedAttention7(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PolarizedAttention8(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PolarizedAttention9(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
        ...
        self.up_pool5 = up_pooling(512, 256)
        self.att5 = ParallelPolarizedSelfAttention(channel=256)
        self.up_conv5 = conv_bn_leru(256 * 3, 256)
...
class Unet6_512_PolarizedAttention10(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PolarizedAttention11(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
...
class Unet6_512_PolarizedAttention12(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        # down
        self.conv1 = conv_bn_leru(in_ch, 16)
