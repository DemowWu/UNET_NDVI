...
from ndvi_models.unet_danet import Unet6_512_DAUNet7, Unet6_512_DAUNet8, Unet6_512_DAUNet9
...
if __name__ == '__main__':
    ...
    if 'train' in args.action:
        ...
        # scheduler
        lr_scheduler = None  # lr_scheduler调整策略：根据训练次数
        if scheduler_name == 'step':# lr更新策略：每依据step_size个epoch，做一次更新
            lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=40, gamma=0.1)
        if scheduler_name == 'expo':# 每个epoch都做一次更新
