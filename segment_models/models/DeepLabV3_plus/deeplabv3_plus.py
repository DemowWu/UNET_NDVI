...
from segment_models.models import backbone
from segment_models.modules import ASPPBlock
from segment_models.utils_Deeplab import SyncBN2d
...
class DeepLabv3_plus(nn.Module):
    def __init__(self, in_channels, num_classes, backend='resnet18', os=16, pretrained='imagenet'):
        ...
        self.zeroconv = nn.Conv2d(self.in_channes, 3, kernel_size=3, stride=1, padding=1)
